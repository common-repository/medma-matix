...
/**
 * Defines style and script for customize templates.
 * 
 *
 * Defines all style and script and example how to add 
 * text-editors to customize templates
 *
 * @since      1.0.0
 */
	...
	wp_enqueue_style( 'quills-csss', plugins_url('../public/css/quill.snow.css', __FILE__ ));
